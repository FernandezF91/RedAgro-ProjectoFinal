							...
							<MDBTableBody>
								{
									item.detalleReserva.map(detalleUnaReserva => (
										<tr key={"row-expanded-" + item.id} visible="false">
											...
											<td><NumberFormat value={detalleUnaReserva.precio_por_unidad} displayType={'text'} thousandSeparator={"."} decimalSeparator={","} prefix="$ " decimalScale={2} fixedDecimalScale={true} /></td>
											<td><NumberFormat value={detalleUnaReserva.precio_por_unidad * detalleUnaReserva.cantidad} displayType={'text'} thousandSeparator={"."} decimalSeparator={","} prefix="$ " decimalScale={2} fixedDecimalScale={true} />
											</td>
										</tr>
									))
								}
