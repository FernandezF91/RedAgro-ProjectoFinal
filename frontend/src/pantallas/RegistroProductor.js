...
class RegistroProductor extends Component {
    ...
    validarCampos() {
        ...
        if (!this.state.campos["razonSocial"]) {
            validaciones["razonSocial"] = "Campo requerido";
            showModal = true;
        }
                        ...
                        <div className="contenidoRegistro">
                            ...
                            <Form.Group as={Row} className="camposGeneral">
                                ...
                                <MDBCol sm={10}>
                                    <MDBRow>
                                        <Form.Control
                                            value={this.state.campos["razonSocial"]}
                                            name="razonSocial"
                                            onChange={(e) => this.detectarCambios(e)}
                                            className="camposDatosDeUsuario"
                                            onKeyPress={this.onKeyPress}
                                        />
                                        {
                                            (this.state.validaciones["razonSocial"]) &&
                                            <i className="fa fa-exclamation-circle mensajeErrorForm" />
                                        }
                                    </MDBRow>
                                    {
                                        (this.state.validaciones["razonSocial"]) &&
                                        <MDBRow>
                                            <div className="mensajeErrorCampos col-md-8">{this.state.validaciones["razonSocial"]}</div>
                                        </MDBRow>
                                    }
                                </MDBCol>
                            </Form.Group>
