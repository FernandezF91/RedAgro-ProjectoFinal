...
class PerfilProductor extends Component {
    ...
    componentDidMount() {
        var path = "redAgro/usuario/obtenerUsuarioByMail?usuario=" + this.state.nombrePerfil;
        fetch(path)
    ...
    obtenerProductos(id_productor) {
        var path = "redAgro/obtenerProductosProductor?id=" + id_productor;
        fetch(path)
            .catch(error => console.error(error))
            .then(response => {
                try {
    ...
    obtenerCalificaciones(id_productor) {
        var path = "redAgro/obtenerPromedioCalificaciones?id_productor=" + id_productor;
        fetch(path)
            .catch(error => console.error(error))
            .then(response => {
                try {
    ...
    obtenerCantidadDeReservasCalificadas(id_productor) {
        var path = "redAgro/obtenerCantidadDeReservasCalificadas?id_productor=" + id_productor;
        fetch(path)
            .catch(error => console.error(error))
            .then(response => {
                try {
    ...
    obtenerListadoFechasEntrega(id_productor) {
        ...
        var path = "redAgro/obtenerEntregasProximoMes?id_productor=" + id_productor;
