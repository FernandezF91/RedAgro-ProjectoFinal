...
class NuevoProducto extends Component {
    ...
    handleSubmit(e) {
        ...
        if (_this.validarCampos()) {
            var path_principal = "http://"+window.$ip+":3000/redAgro/usuario_productor/nuevo_producto?id_productor=";
    ...
    obtenerTiposProducto(categoria) {
        ...
        const path_principal = "http://"+window.$ip+":3000/redAgro/obtenerTiposProducto?categoria_producto=";
