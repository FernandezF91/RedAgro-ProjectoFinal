                                ...
                                <MDBCol lg="4" md="6" className="mb-lg-0 mb-4" key={item.id}>
                                    <MDBCard narrow ecommerce className="mb-4">
                                        ...
                                        <MDBCardBody className="text-center">
                                            ...
                                            <MDBCardTitle>
                                                <strong>
                                                    <button type="button" className="dark-grey-text link-button overflowTexto col-md" onClick={() => mostrarDetalleProducto(item)} title="Clickeá para ver el detalle del producto">{item.titulo}</button>
                                                </strong>
                                            </MDBCardTitle>
                                            <MDBCardText>
