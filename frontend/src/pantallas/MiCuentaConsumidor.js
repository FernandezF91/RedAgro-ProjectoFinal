...
class MiCuenta extends Component {
    ...
    obtenerMensajeReservasPendiente() {
        ...
        var path_usuario = "redAgro/obtenerCantidadReservasDisponiblesConsumidor?id_consumidor=" + _this.state.id_usuario;
    ...
    obtenerProductosDePreferencia() {
        ...
        var path = "redAgro/preferencias/obtenerProductos?id=" + _this.state.id_usuario;
        fetch(path)
