...
class AlertaProductor extends Component {
    ...
    componentDidMount() {
        var _this = this;
        var path = "http://"+window.$ip+":3000/redAgro/obtenerConfiguracionAlertas?id_usuario=" + _this.state.id;
        fetch(path)
    ...
    handleFormSubmit = formSubmitEvent => {
        ...
        var path = "http://"+window.$ip+":3000/redAgro/guardarConfiguracionAlertas?id_usuario=" + this.state.id;
        fetch(path, {
            method: "POST",
